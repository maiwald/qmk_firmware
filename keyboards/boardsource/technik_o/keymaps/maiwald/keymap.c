...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MEDIA] = LAYOUT_ortho_4x12(
      KC_BRIU, UG_VALU, XXXXXXX, UG_NEXT, UG_HUEU, UG_SATU, KC_MPRV, KC_MNXT, XXXXXXX, KC_VOLD, KC_VOLU, XXXXXXX,
      KC_BRID, UG_VALD, XXXXXXX, UG_PREV, UG_HUED, UG_SATD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
