...
#define COL_S     LALT_T(DE_S)
#define COL_T     LGUI_T(DE_T)
#define COL_N     RGUI_T(DE_N)
#define COL_E     RALT_T(DE_E)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MEDIA] = LAYOUT_ortho_4x12(
      KC_BRIU, RGB_VAI, XXXXXXX, RGB_MOD,  RGB_HUI, RGB_SAI, KC_MPRV, KC_MNXT, XXXXXXX, KC_VOLD, KC_VOLU, XXXXXXX,
      KC_BRID, RGB_VAD, XXXXXXX, RGB_RMOD, RGB_HUD, RGB_SAD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
      XXXXXXX, XXXXXXX, XXXXXXX, RGB_M_P,  XXXXXXX, XXXXXXX, COL_SET, PUQ_SET, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPLY,
