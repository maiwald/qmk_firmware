...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EXTEND] = LAYOUT_ortho_4x12(
      APP_TAB, XXXXXXX, DE_7,    DE_8,    DE_9,     DE_PLUS, XXXXXXX, XXXXXXX, VIM_ALT, XXXXXXX, KC_MNXT, KC_MPLY,
      XXXXXXX, KC_LCTL, HOME_4,  HOME_5,  HOME_6,   DE_MINS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, KC_VOLU,
      XXXXXXX, XXXXXXX, DE_1,    DE_2,    DE_3,     XXXXXXX, XXXXXXX, XXXXXXX, DE_COMM, DE_DOT,  DE_SLSH, KC_VOLD,
